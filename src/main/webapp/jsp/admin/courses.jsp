...
<body>
    <div class="container">
        ...
        <% if (request.getParameter("success") != null) { 
            ...
            String message = "";
            if ("add".equals(success)) message = "课程添加成功！";
            else if ("update".equals(success)) message = "课程更新成功！";
            else if ("delete".equals(success)) message = "课程删除成功！";
        %>
        ...
        <% if (request.getParameter("error") != null) { 
            ...
            String message = "";
            if ("delete".equals(error)) message = "删除课程失败！";
                ...
                <tbody>
                    <% for (CourseModel course : courses) { %>
                        <tr>
                            ...
                            <td><%= course.getTeacherId() != null ? course.getTeacherId() : "未分配" %></td>
                            ...
                            <td>
                                <div class="actions-cell">
                                    <a href="${pageContext.request.contextPath}/admin/courses?action=edit&id=<%= course.getId() %>" 
                                       class="btn btn-warning">编辑</a>
                                    <button onclick="confirmDelete(<%= course.getId() %>, '<%= course.getName() %>')" 
