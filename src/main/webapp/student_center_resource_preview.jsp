...
<%
    ...
    // 验证资源是否属于当前用户
    if (!resource.getUploaderId().equals(user.getId())) {
...
<head>
    ...
    <title>资源预览 - <%= resource.getTitle() %> - 学生个人中心</title>
...
<div class="container">
    <div class="header">
        <h1>📋 资源预览</h1>
        <a href="${pageContext.request.contextPath}/student_center.jsp" class="btn btn-secondary">返回个人中心</a>
    </div>
